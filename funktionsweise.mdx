---
title: "Funktionsweise im LCM"
---

Der Struktureditor kuratiert die juristische Intelligenz des LCM. Der LCM stellt seinen Nutzer:innen die juristischen Strukturen, Prüfschemata und Templates für ca. 50 % der zivilgerichtlichen und ca. 60 % der arbeitsgerichtlichen Streitigkeiten vor deutschen Gerichten "out of the box" zur Verfügung. Die vorintegrierten Inhalte wachsen täglich. 

Die Nutzer:innen können zudem auf "no code basis" - also ohne jede Programmier-Kenntnisse in einer anwenderfreundlichen Eingabemaske - ihr eigenes Wissen strukturiert im LCM integrieren und in der juristischen Fallbearbeitung anwenden.

> Die Strukturierung wird einerseits in der **dynamischen Relation** in Textkärtchen <u>visualisiert</u>. In der **Rechtsmatrix** - aktuell: der Privatrechtsmatrix - wird der aktuelle Verfahrensstand nach den entscheidenden rechtlichen Parametern <u>analysiert</u>.

Das Wissen der Organisation bleibt im Struktureditor erhalten, auch wenn Mitarbeitende ausscheiden. Die Einarbeitung neuer Mitarbeitender wird erleichtert, da das juristische Wissen und die Erfahrung in der Datenbank erhalten bleiben.
...
In Zusammenarbeit mit Professor Marco Mansdörfer der Universität des Saarlandes werden aktuell die für die juristische Ausbildung und Praxis relevanten strafrechtlichen Normstrukturen der praktisch wichtigsten Straftatbestände in den LCM integriert.