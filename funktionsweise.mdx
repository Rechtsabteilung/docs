...
> Die Strukturierung wird einerseits in der **dynamischen Relation** in Textkärtchen visualisiert. In der **Rechtsmatrix** - aktuell: der Privatrechtsmatrix - wird der aktuelle Verfahrensstand analysiert.

Das Wissen der Organisation bleibt erhalten, auch wenn Mitarbeitende ausscheiden. Die Einarbeitung neuer Mitarbeitenden wird erleichtert, da das juristische Wissen und die Erfahrung in der Datenbank erhalten bleibt.
