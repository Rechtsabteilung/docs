...
Der LCM nutzt die im Struktureditor vorintegrierten Schemata und Baumstrukturen samt der zu den Merkmalen vorintegrierten Definitionen und Textbausteinen zur Produktion der von den Nutzer:innen gewünschten Texte: Entwürfe vorgerichtlicher Schreiben, von Klageschriften und Klageerwiderungen sowie sonstigen Schriftstücken (wie z.B. Rechtsgutachten, Versicherer-Reports, Mandant:innen-Reports usw.) werden auf diese Weise regelbasiert und deterministisch erstellt.